...
/**
 * EVENT工具类 Deprecated Please Replace by RowChangeHelper
 * <p/>
...
@Deprecated
public class JingWeiEventHelper {
    ...
    public static MapData convertEvent2Map(DBMSRowChange event, boolean upperCase) {
        ...
        if (DBMSAction.UPDATE == action) {
            ...
            List<Map<String, Object>> rowDataMaps = new ArrayList<Map<String, Object>>(rowSize);
            List<Map<String, Object>> modifyRowDataMaps = new ArrayList<Map<String, Object>>(rowSize);
            for (int i = 1; i <= rowSize; i++) {
                Map<String, Object> rowDataMap = new HashMap<String, Object>(allColumns.size());
                Map<String, Object> modifyRowDataMap = new HashMap<String, Object>(allColumns.size());
                ...
                for (DBMSColumn column : allColumns) {
                    ...
                    Object columnValue = rowData.getRowValue(column);
                    // 设置修改前rowDataMap
                    rowDataMap.put(columnName, columnValue);
                    if (modifyColumns.contains(column)) {
                        // 如果当前字段是修改的字段，使用修改的值
                        Object modifyColumnValue = event.getChangeValue(i, column);
    ...
    public static class MapData {
         ...
         */
        private List<Map<String, Object>> rowDataMaps;

        /**
         * 修改后数据,只有Update的时候才有
         */
        private List<Map<String, Object>> modifyRowDataMaps;
        ...
        public List<Map<String, Object>> getRowDataMaps() {
            return rowDataMaps;
        }

        public void setRowDataMaps(List<Map<String, Object>> rowDataMaps) {
            this.rowDataMaps = rowDataMaps;
        }

        public List<Map<String, Object>> getModifyRowDataMaps() {
            return modifyRowDataMaps;
        }

        public void setModifyRowDataMaps(List<Map<String, Object>> modifyRowDataMaps) {
