...
public class UDCIDCTaskLoader {

	private static final String TASK_NAME = "udc-uic-loader-test";

	private static final String DB_PROPER_FILE = "udc-uic-replicator.properties";
