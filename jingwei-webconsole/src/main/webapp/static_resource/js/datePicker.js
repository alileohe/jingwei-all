...
"ui-datepicker-days-cell-over";this.regional=[];this.regional[""]={closeText:"Done",prevText:"上月",nextText:"下月",currentText:"今天",monthNames:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],monthNamesShort:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],dayNames:["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],dayNamesShort:["日","一","二","三","四","五","六"],dayNamesMin:["日","一","二","三","四","五","六"],weekHeader:"Wk",dateFormat:"yyyy-mm-dd",firstDay:0,isRTL:false,showMonthAfterYear:false,yearSuffix:""};this._defaults={showOn:"focus",showAnim:"fadeIn",showOptions:{},defaultDate:null,appendText:"",buttonText:"...",buttonImage:"",buttonImageOnly:false,hideIfNoPrevNext:false,navigationAsDateFormat:false,gotoCurrent:false,changeMonth:false,changeYear:false,yearRange:"c-10:c+10",showOtherMonths:false,selectOtherMonths:false,showWeek:false,calculateWeek:this.iso8601Week,shortYearCutoff:"+10",
...
/*
* virtualScroller 1.0.0 (2011-07-08)
*
* Copyright (c) 2011 Shanghai Joying
*
*/
(function ($) {

    $.fn.virtualScroller = function () {
        var container = this;

        if (container[0].clientHeight < container[0].scrollHeight) {
            var scroller = $('<div id="' + container.attr('id') + '"_scroller style="width:18px; overflow-y:scroll; position:absolute; top:0px; left:-100px; display:none"><div></div></div>').insertAfter(container);
            container.bind((document.all ? "mousewheel" : "DOMMouseScroll"), function (e) {
                var scrollTop = e.wheelDelta || e.detail;
                scrollTop = (scrollTop > 0 ? 10 : -10);
                if ($.browser.msie) scrollTop = -scrollTop;
                container.scrollTop(container.scrollTop() + scrollTop);
                scroller.scrollTop(scroller.scrollTop() + scrollTop);
                return false;
            });
            scroller.css({ 'display': 'block', 'height': container.height() }).scroll(function () {
                container.scrollTop(this.scrollTop);
            }).children().css('height', container[0].scrollHeight);
            var positionScroller = function () {
                if (scroller.css('display') != 'block') {
                    return;
                }
                var offset = container.offset();
                scroller.css({ 'top': offset.top, 'left': offset.left + container.width() });
            };
            positionScroller();
            $(window).bind('resize', positionScroller);
        }
        else {
            container.css('height', container.children().height());
        }
